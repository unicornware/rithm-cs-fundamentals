/**
 * @file Unit Tests - linearSearchRecursive
 * @module csf/topics/searching/exercises/tests/unit/linearSearchRecursive
 */

import type { TestcaseFn } from '@tests/interfaces'
import testSubject from '../linear-search-recursive'

describe('unit:searching/exercises/linearSearchRecursive', () => {
